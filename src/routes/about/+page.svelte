<div class="flex items-center justify-center m-10">
	<div class="text-white text-3xl text-center">
	  <h2>MSOL SNS by <a class="text-green-400" href="https://wilfredalmeida.com" target="_blank">WilfredAlmeida</a></h2><br>
	  <h3>MSOL aims to take away your hassle for remenbering your Solana Public Key.</h3> <br>
